...
const Footer = () => {
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-blue-800 pt-10"
      data-wow-delay=".15s"
    >
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <Link href="/" className="mb-6 inline-block max-w-[160px]">
                <Image
                  src="/images/logo/logo-bright.svg"
                  alt="logo"
                  width={140}
                  height={30}
              ...
              <p className="mb-8 max-w-[300px] text-base text-gray-7">
                We create digital fundraisings for all.
              </p>
              <div className="-mx-3 flex items-center">
                ...
                <a
                  ...
                  className="px-3 text-gray-7 hover:text-white"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" viewBox="-50 -60 400 400" className="fill-current">
                    <path clip-rule="evenodd" d="M25 0h200c13.808 0 25 11.192 25 25v200c0 13.808-11.192 25-25 25H25c-13.808 0-25-11.192-25-25V25C0 11.192 11.192 0 25 0z" 
                        fill-rule="evenodd" fill="#ced4da" />
                    <path clip-rule="evenodd" d="M156.98 230c7.607 0 13.774-6.117 13.774-13.662 0-7.545-6.167-13.663-13.774-13.663h-2.075c7.607 0 13.774 6.118 13.774 13.663S162.512 230 154.905 230z" 
                        fill-rule="evenodd" fill="#1e40af" />
                    <path clip-rule="evenodd" d="M154.717 202.675h-2.075c-7.607 0-13.775 6.118-13.775 13.663S145.035 230 152.642 230h2.075c-7.608 0-13.775-6.117-13.775-13.662 0-7.545 6.167-13.663 13.775-13.663z" 
                        fill-rule="evenodd" fill="#1e40af" />
                    <ellipse ry="6.643" rx="6.699" clip-rule="evenodd" fill-rule="evenodd" fill="#010101" cy="216.338" cx="154.811" />
                    <path clip-rule="evenodd" d="M50 196.5v6.925h8.112v26.388h8.115v-26.201h6.603l2.264-7.112zm66.415 0v6.925h8.112v26.388h8.115v-26.201h6.603l2.264-7.112zm-39.81 3.93c0-2.17 1.771-3.93 3.959-3.93 2.19 0 3.963 1.76 3.963 3.93s-1.772 3.93-3.963 3.93c-2.188-.001-3.959-1.76-3.959-3.93zm0 6.738h7.922v22.645h-7.922zM87.924 196.5v33.313h7.925v-8.608l2.453-2.248L106.037 230h8.49l-11.133-16.095 10-9.733h-9.622l-7.923 7.86V196.5zm85.47 0v33.313h7.926v-8.608l2.452-2.248L191.509 230H200l-11.133-16.095 10-9.733h-9.622l-7.925 7.86V196.5z" 
                        fill-rule="evenodd" fill="#1e40af" />

                    <path clip-rule="evenodd" d="M153.012 74.405c10.947 7.819 24.353 12.42 38.832 12.42V64.902c-8.082-1.72-15.237-5.942-20.617-11.814-9.208-5.743-15.843-15.218-17.788-26.308H133.14v111.239c-.046 12.968-10.576 23.468-23.561 23.468-7.652 0-14.45-3.645-18.755-9.292-7.688-3.878-12.96-11.84-12.96-21.035 0-13.005 10.547-23.548 23.56-23.548 2.493 0 4.896.388 7.15 1.103V86.553c-27.945.577-50.42 23.399-50.42 51.467 0 14.011 5.597 26.713 14.68 35.993 8.195 5.5 18.06 8.707 28.673 8.707 28.445 0 51.505-23.048 51.505-51.479z" 
                        fill-rule="evenodd" fill="#1e40af" />
                  </svg>
                </a>
              </div>
            ...
            <div className="mb-10 w-full">
              <ul>
                <li>
                  <a
                    href="/#"
                    className="mb-3 inline-block text-base text-gray-7 hover:text-blue-400"
                  >
                    Home
                  </a>
                </li>
      ...
      <div className="mt-8 border-t border-[#8890A4] border-opacity-40 py-4 lg:mt-[40px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                <p className="text-base text-gray-7">
                  Copyright @2024 Zuboost International Inc.
                </p>
              </div>
            </div>
          </div>
